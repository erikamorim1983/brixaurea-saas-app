        ...
        headers: [
          ...
          // Content Security Policy (CSP)
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://*.supabase.co https://*.googleusercontent.com https://maps.googleapis.com https://maps.gstatic.com https://*.ggpht.com",
              "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://apis.google.com https://www.googleapis.com https://maps.googleapis.com",
