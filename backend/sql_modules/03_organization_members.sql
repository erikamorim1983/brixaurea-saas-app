...
DROP POLICY IF EXISTS "Owner can add first member" ON public.organization_members;

-- Allow owner to insert themselves as first member (bootstrap)
CREATE POLICY "Owner can add first member"
